...
```c
    ...
    sub_4B64870(a1: v2, a2: 4294967294LL, a3: "__mode"); // <-- lua_unref
    sub_4B63BF0(a1: v2, a2: -10000, a3: *(_DWORD *)(a1 + 24));
    if ( (unsigned int)sub_4B65630(a1: v2, a2: -1) != 0 )
    {
      sub_4B64870(a1: v2, a2: 4294967294LL, a3: "result"); // <-- lua_unref
      ...
      *(_DWORD *)(a1 + 28) = sub_4B642F0(a1: v2, a2: 0xFFFFFFFFLL); // <-- lua_ref
      ...
      if ( byte_7F2DF28 != 0 )
      {
        *(_DWORD *)(a1 + 24) = sub_4B656B0(a1: (__int64)v2, a2: v3);
      }
      else
      {
        sub_4B656B0(a1: (__int64)v2, a2: v3);
        *(_DWORD *)(a1 + 24) = -1;
      }
```
