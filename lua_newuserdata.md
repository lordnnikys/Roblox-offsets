...
To find lua_newuserdata we'll use already known offset luaopen_bit32 which in my case is at 0x4B84E20, jump to it and look down, you'll see:
```c
...
__int64 __fastcall sub_4B84E50(__int64 a1)
{
  ...
  v2 = sub_4B69590(a1, a2: 1);
  if ( v2 < 0 )
    sub_4B69390(a1, a2: 1, a3: "size");
  sub_4B62B20(a1, a2: v2); // <-- lua_newuserdata
  return 1;
}
```
